...
def decimal_To_Others():
    ...
    def decimal_to_binary():
        ...
        dtb=dtb[2:]
        E55.insert(0,dtb)
    B5=Tkinter.Button(top1,relief=RAISED,text="Convert Binary to Decimal",fg='white',bg='purple',command=abc3)
...
def octal_To_Others():
    ...
    RESET3=Button(top2,text="RESET",fg="blue",bg="black",command=reset_entries3)
    RESET3.grid(row=20,column=2)
    def close_window3(): 
        top2.destroy()
    EXIT3=Button (top2,text = "EXIT",fg="blue",bg="black",command=close_window3)
